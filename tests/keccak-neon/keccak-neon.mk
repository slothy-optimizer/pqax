...
KECCAK_NEON_ASMS += $(KECCAK_NEON_ASM_DIR)/keccak_f1600_x4_v8a_hybrid_slothy_clean.s
KECCAK_NEON_ASMS += $(KECCAK_NEON_ASM_DIR)/keccak_f1600_x4_v8a_hybrid_slothy_interleaved.s
KECCAK_NEON_ASMS += $(KECCAK_NEON_ASM_DIR)/keccak_f1600_x4_v8a_v84a_hybrid_slothy_clean.s
KECCAK_NEON_ASMS += $(KECCAK_NEON_ASM_DIR)/keccak_f1600_x4_v8a_v84a_hybrid_slothy_interleaved.s
KECCAK_NEON_ASMS += $(KECCAK_NEON_ASM_DIR)/keccak_f1600_x4_v84a_hybrid_slothy_clean.s
KECCAK_NEON_ASMS += $(KECCAK_NEON_ASM_DIR)/keccak_f1600_x4_v84a_hybrid_slothy_interleaved.s
